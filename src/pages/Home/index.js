    ...
    <Layout>
      <div className={`${styles.page} ${styles.pageHero}`}>
        <main className={styles.hero}>
            ...
            <a className="LinkClass" href="https://wa.me/5511991407988?text=Olá, gostaria de conhecer vocês!">CONHEÇA-NOS</a >
        </main>
      </div>
      ...
      <div className={`${styles.page} ${styles.page1}`}>
        <main className={styles.sectionContent}>
          ...
          <Link className="LinkClass" to="/contato">VISITE-NOS</Link >
        </main>
      ...
      <div className={styles.caffeAsset2}>
        ...
        <main className={styles.secondSectionContent}>
          ...
          <Link className="LinkClass" to="/contato">ENCOMENDE</Link >
        </main>
      </div>
